...
//        FuenteRepositorio fuenteRepositorio = new FuenteRepositorio(emf);
        ...
        app.post("/colecciones/{id}/agregador.fuente", new PostFuentesColeccionRepoHandler(coleccionRepositorio));
        app.delete("/colecciones/{id}/agregador.fuente", new DeleteFuenteRepoHandler(coleccionRepositorio));
        app.put("/colecciones/{id}/algoritmo", new PutAlgoritmoDeConsensoRepoHandler(coleccionRepositorio));

        //agregador.Solicitudes

...
import cargadorEstatico.domain.Consenso.Absoluta;
import cargadorEstatico.domain.Consenso.AlgoritmoConsenso;
import cargadorEstatico.domain.Consenso.MayoriaSimple;
import cargadorEstatico.domain.Consenso.MultiplesMenciones;
import cargadorEstatico.domain.Criterios.Criterio;
import cargadorEstatico.domain.HechosYColecciones.Hecho;
import cargadorEstatico.domain.HechosYColecciones.ModosDeNavegacion;

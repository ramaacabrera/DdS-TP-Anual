...
import estadisticas.domain.Consenso.Absoluta;
import estadisticas.domain.Consenso.AlgoritmoConsenso;
import estadisticas.domain.Consenso.MayoriaSimple;
import estadisticas.domain.Consenso.MultiplesMenciones;
import estadisticas.domain.Criterios.Criterio;
import estadisticas.domain.HechosYColecciones.Hecho;
import estadisticas.domain.HechosYColecciones.ModosDeNavegacion;
import estadisticas.domain.HechosYColecciones.TipoAlgoritmoConsenso;

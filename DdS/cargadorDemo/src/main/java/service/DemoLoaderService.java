...
import domain.HechosYColecciones.ContenidoMultimedia;
...
public class DemoLoaderService implements FuenteExternaConexion {
    protected final String url;
    private final ObjectMapper objectMapper;
    public LocalDateTime fechaUltimaConsulta;

    public DemoLoaderService(String urlServicioExterno) {
    ...
    /*public service.DemoLoader(String urlServicioExterno) {
    ...
    private HechoDTO mapHechoMockAHechoDTO(HechoMock hechoMock) {
        ...
        etiquetas.add(new Etiqueta("agregador.fuente-demo"));
        ...
        // Validar título antes de crear utils.DTO

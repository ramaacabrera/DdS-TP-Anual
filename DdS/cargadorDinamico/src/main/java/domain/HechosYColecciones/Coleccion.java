...
import domain.DinamicaDto.ColeccionDTO;
import domain.Consenso.Absoluta;
import domain.Consenso.AlgoritmoConsenso;
import domain.Consenso.MayoriaSimple;
import domain.Consenso.MultiplesMenciones;

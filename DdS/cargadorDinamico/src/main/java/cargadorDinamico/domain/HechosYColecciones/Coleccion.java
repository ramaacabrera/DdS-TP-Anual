...
import cargadorDinamico.domain.DinamicaDto.ColeccionDTO;
import cargadorDinamico.domain.Consenso.Absoluta;
import cargadorDinamico.domain.Consenso.AlgoritmoConsenso;
import cargadorDinamico.domain.Consenso.MayoriaSimple;
import cargadorDinamico.domain.Consenso.MultiplesMenciones;
import cargadorDinamico.domain.Criterios.Criterio;

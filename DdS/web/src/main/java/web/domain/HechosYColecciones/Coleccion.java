...
import web.domain.Consenso.Absoluta;
import web.domain.Consenso.AlgoritmoConsenso;
import web.domain.Consenso.MayoriaSimple;
import web.domain.Consenso.MultiplesMenciones;

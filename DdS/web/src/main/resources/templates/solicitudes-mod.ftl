...
<#assign content>
    <div class="container">
        ...
        <h1 class="main-title">Solicitudes de Modificacion</h1>
        ...
        <div class="filtros-estado" style="margin-bottom: 30px;">
            ...
            <div class="filtros-botones" style="display: flex; gap: 12px; flex-wrap: wrap;">
                <!-- Botón para TODAS -->
                <a href="/admin/solicitudes/modificacion?page=1&size=${(size!10)?c}"
                ...
                <a href="/admin/solicitudes/modificacion?estado=PENDIENTE&page=1&size=${(size!10)?c}"
                ...
                <a href="/admin/solicitudes/modificacion?estado=ACEPTADA&page=1&size=${(size!10)?c}"
                ...
                <a href="/admin/solicitudes/modificacion?estado=RECHAZADA&page=1&size=${(size!10)?c}"
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                    <div>
                        <p style="font-size: 1.5rem; font-weight: bold; color: var(--primary-color); margin: 0;">
                            ${totalSolicitudes!solicitudesModificacion?size} solicitud(es)
                            <#if estadoFiltro?? && estadoFiltro != "">
    ...
    <#if totalPages?? && (totalPages > 1)>
        <div class="page-btn" style="display: flex; justify-content: center; margin: 30px 0;">
            ...
            baseHref=(baseHref!"/admin/solicitudes/modificacion")
